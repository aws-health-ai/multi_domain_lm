...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--train_subset_tem', default=None,
                        help='')
    parser.add_argument('--fisher_lambda', default=0.5, type=float, metavar='D',
                        help='')
    parser.add_argument('--no_fisher', action='store_true', help='No Fisher weights')
    parser.add_argument('--invert_fisher', action='store_true', help='Invert Fisher regularizer')

    parser.add_argument('--use_ulmfit', action='store_true', help='No Fisher weights')
    parser.add_argument('--decay_rate_lrc', default=2.6, type=float, metavar='D',
                        help='')
    parser.add_argument('--num_layers', default=12, type=int, metavar='D',
                        help='')
