...
def main(args, init_distributed=False):
    ...
    extra_state, epoch_itr, epoch_itr_fisher = checkpoint_utils.load_checkpoint(args, trainer)
    ...
    if not args.use_ulmfit:
        trainer.freeze_old_model()
        print('| Creating Fisher matrix')
        fisher(args, trainer, epoch_itr_fisher)
